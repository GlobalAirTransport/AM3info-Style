...
while(i < 326) {
    ...
    switch (checker) {
                ...
                case "id76":
                speed = 831; cap = 215; rwy = 7550; mC = 1014850; range = 5925; fConsmp = 11.11; cConsmp = 0.14; mH = 500; price = 9225912; 
                n = "B737-900ER"; c = 5
                break;
...
function resell() {
    ...
    if (plane == "" || market == "" || flh == "" || jS == "" || fS == "") {
        ...
        $(`#res-tab8`).animate({ bottom: '0' })
        $(`#res-container8`).animate({ bottom: '0' })
    }
}